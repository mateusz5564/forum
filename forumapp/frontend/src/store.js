  ...
  actions: {
    ...
    doLogin({ commit }, loginData) {
      ...
      .then(response => {
        ...
        commit('updateUserRole', response.data.user.is_staff);
    ...
    fetchUserRole({ commit }) {
      commit('updateUserRole', localStorage.getItem('isStaff') == 'true' ? true : false)
    },
    fetchUserId({ commit }) {
